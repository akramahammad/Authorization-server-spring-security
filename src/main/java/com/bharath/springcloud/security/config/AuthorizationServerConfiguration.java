...
public class AuthorizationServerConfiguration {
	...
	public SecurityFilterChain authServerSecurityFilter(HttpSecurity http) throws Exception {
	...
	@Bean
	public JwtDecoder jwkDecoder(JWKSource<SecurityContext> jwkSource) {
	...
	public JWKSource<SecurityContext> jwkSource() throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException{
		JWKSet jwtSet= this.buildJWKSet();
	...
	@Bean
	public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomiser(){
		return context ->{
